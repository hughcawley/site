...
export class PortfolioComponent implements OnInit {
  ...
  cases =[
    ...
    {"title" : "AOR Plastering", "img": "FCEM.png", "skills": ["Automation Systems Development", "Maintenance & Support", "Google Advertising: Adwords", "Google My Business Management"] , "desc" : "With Full Circle, my tasks focus around maintaining their online ?? looking for ways to streamline their tech side of things & developing automation systems. I have developed stock ordering, stock management, holiday processing and software and XYZ","duration" : "2 Years", "tools" : ["Adobe Illustrator", "Google Admin", "Google Script Editor", "Custom API's" , "Pipedrive CRM"]},


    {"title" : "Footfall", "img": "footfall.png", "skills": ["Graphic Design", "Google Analytics Reporting", "Search Engine Optomization", "Maintenance & Support", "Website Design & Development"] , "desc" : "With Full Circle, my tasks focus around maintaining their online ?? looking for ways to streamline their tech side of things & developing automation systems. I have developed stock ordering, stock management, holiday processing and software and XYZ","duration" : "8+ Months", "tools" : ["Adobe Illustrator", "Google Admin", "Google Script Editor", "Custom API's" , "Pipedrive CRM"]},
    ...
    {"title" : "Azzurri Print", "img": "ap.jpeg", "skills": ["Website Design & Development", "Graphic Design", "GTM Setup", "Facebook Pixel Setup"] , "desc" : "With Full Circle, my tasks focus around maintaining their online ?? looking for ways to streamline their tech side of things & developing automation systems. I have developed stock ordering, stock management, holiday processing and software and XYZ","duration" : "8+ Months", "tools" : ["Adobe Illustrator", "Google Admin", "Google Script Editor", "Custom API's" , "Pipedrive CRM"]},
