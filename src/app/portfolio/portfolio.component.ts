...
export class PortfolioComponent implements OnInit {
  ...
  cases =[
    ...
    {"title" : "Studio Minti","id": "studio", "anchor":  "https://studiominti.com", "tagline" : "Fashion Store", "img": "minti.png", "skills": ["Web Design", " AWS Web Hosting", "Maintenance & Support"] , "desc" : "With Full Circle, my tasks focus around maintaining their online ?? looking for ways to streamline their tech side of things & developing automation systems. I have developed stock ordering, stock management, holiday processing and software and XYZ","duration" : "1 Year", "tools" : ["Adobe Illustrator", "Shopify", "Google Admin", "Google Script Editor", "Custom API's" , "Amazon Web Services"]},

    {"title" : "Ocean Sands Hotel", "id": "osh","anchor":"https://theoceansandshotel.ie","tagline" : "Luxury Hotel", "img": "os.png", "skills": ["Graphic Design", "Search Engine Optomization" , "Web Design", "Maintenance & Support"] , "desc" : "With Full Circle, my tasks focus around maintaining their online ?? looking for ways to streamline their tech side of things & developing automation systems. I have developed stock ordering, stock management, holiday processing and software and XYZ","duration" : "9+ Months", "tools" : ["Adobe Illustrator", "Google Admin", "Google Script Editor", "Custom API's" , "Netafinity"]},

    {"title" : "Jellybean", "id": "jb","tagline" : "Children's Furniture Store", "anchor" : "https://www.jellybeangroup.com" , "img": "jb.png", "skills": ["Website Management", "Ecommerce Stock Management Automation", "Stock Management", "Google Advertising (Shopping & Adwords)", "Google Analytics Reporting" , "Email Design & Marketing", "Maintenance & Support"], "desc" : "My first job in the field! Initially with Jellybean I was brought on to ovesee their website from a functionality & visual standpoint. I was tasked with making small edits to the site or to manage the stock we had on the ecommerce site. As time went on, I was given more responsibility. I was put in charge of advertising, analysing our audience and building our online presence. I really appreciated this job for giving me a wealth of real-world experience in a number of fields within IT.","duration" : "5+ Years", "tools" : ["HootSuite", "Google Adwords", "Google Analytics", "Google Search Console", "Content Management Systems"], "dimg" : "jb1.png"},
