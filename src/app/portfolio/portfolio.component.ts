...
export class PortfolioComponent implements OnInit {
  ...
  cases =[
    ...
    {"title" : "DND Detailing", "img": "dnd.png","anchor":"", "skills": ["Logo Design", "Automation Systems Development", "Maintenance & Support"] , "desc" : "With Full Circle, my tasks focus around maintaining their online ?? looking for ways to streamline their tech side of things & developing automation systems. I have developed stock ordering, stock management, holiday processing and software and XYZ","duration" : "1 Year", "tools" : ["Adobe Illustrator", "Google Admin", "Google Script Editor", "Custom API's" , "Pipedrive CRM"]},
