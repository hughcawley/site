...
export class PortfolioComponent implements OnInit {
  ...
  cases =[
    ...
    {"title" : "Azzurri Print", "img": "ap.png", "skills": ["Website Design & Development", "Payment Gateway Setup", "Graphic Design", "GTM Setup", "Facebook Pixel Setup"] , "desc" : "With Full Circle, my tasks focus around maintaining their online ?? looking for ways to streamline their tech side of things & developing automation systems. I have developed stock ordering, stock management, holiday processing and software and XYZ","duration" : "3+ Months", "tools" : ["Adobe Illustrator", "Google Admin", "Google Script Editor", "Custom API's" ]},
    ...
    {"title" : "AOR Plastering", "img": "aor.png", "skills": ["Maintenance & Support", "Google Advertising: Adwords", "Google My Business Management", "Website Design & Development"] , "desc" : "With Full Circle, my tasks focus around maintaining their online ?? looking for ways to streamline their tech side of things & developing automation systems. I have developed stock ordering, stock management, holiday processing and software and XYZ","duration" : "2 Years", "tools" : ["Adobe Illustrator"]},
